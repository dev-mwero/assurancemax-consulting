		...
		<SectionWrapper>
			<div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
				<div>
					...
					<blockquote className="mt-4 text-2xl font-semibold text-foreground leading-snug sm:text-3xl">
				...
				<div>
					...
					<blockquote className="mt-4 text-lg text-muted-foreground leading-relaxed">
